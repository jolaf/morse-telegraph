    ...
    def readline(self):
        while True:
            ...
            if self.ready and (self.nextMessage is None or now > self.nextMessage):
                ...
                return morseRxResponse.encode('')
            sleep(DT)
